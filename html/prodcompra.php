<?php
    ...
    $seleccion="SELECT * FROM compras WHERE id='".$_POST['IdPedido']."' ";
	$resultado=mysqli_query($conexion, $seleccion);
	$filas=mysqli_fetch_assoc($resultado);
?>
<h2 align="center">Registrar Producto en Entrada</h2>
<div class="panel-body">
	<form class="form-horizontal" method="POST" action="">
	    <input type="hidden" name="IdPedido" id="IdPedido" value="<?php echo $filas['id']; ?>">
		<div class="form-group">
            <label class="col-md-2 control-label" for="IdPedido">ID Entrada: </label>
            <div class="col-md-8">
