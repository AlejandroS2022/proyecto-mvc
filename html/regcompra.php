...
?>
<h2 align="center">Registrar Nueva Entrada</h2>
<div class="panel-body">
	<form class="form-horizontal" method="POST" action="">
        ...
        <button type="submit" class="verde2" value="Regcmp2" name="Regcmp2" id="Regcmp2">Registrar <i class="fa fa-plus-circle"></i></button>
    </form>
    <form class="form-horizontal" method="POST" action="">
